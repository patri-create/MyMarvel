...
class HomeViewModelTest {
    ...
    @Mock
    lateinit var findEventsUseCase: FindEventsByHeroIdUseCase
    ...
    fun setUp() {
        ...
        vm = HomeViewModel(findHeroesUseCase, findEventsUseCase)
    }
    ...
    fun `State events updating`() = runTest {
        ...
        whenever(findEventsUseCase(0)).thenReturn(resultEvents)
    ...
    fun `Verify findEvents is called when updateEvent list`() = runTest {
        ...
        verify(findEventsUseCase).invoke(0)
    }
